...
public class Chinese extends Food{
	...
	System.out.println("");
	try{
		String address = System.getProperty("user.dir"); //Getting current working directory and assigning into directory
            	FileReader fr = new FileReader(address+"//FoodData//Chinese.txt");
		int i;
